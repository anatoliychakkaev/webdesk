...
var Wiky = {
  ...
  rules: {
     ...
     wikiinlines: [
       ...
       { rex:/\[\[([^,]+)[,]?([^\]]*)\]\]/g, tmplt:function($0,$1,$2){return Wiky.store("<span class=\"likealink\" onclick=\"cm('help','"+$1+"');\">"+($2?$2:$1)+"</span>");}},  // wiki block style uri's ..
   ...
   inverse: {
     ...
     wikiinlines: [
	   ...
	   { rex:/<span class=\"likealink\" onclick=\"cm\(\'help\',\'([^\']*)\'\);\">(.*?)<\/span>/mgi, tmplt:function($0,$1,$2){return $1==$2?"[["+$1+"]]":"[["+$1+","+$2+"]]";}},
